const appname = "Personal Budgeting App";
const appversion = "appversion";
const credits = "@GoProgs";
const username = "@Khadim Hussain";
const name = "Name";
const namehint = "Mafi";
const email = "Email";
...
const searchanythig = "Search Anything",
    todayadeal = "Total budget",
    flashsale = "Total spent ",
    topbrand = "Top Brands",
    topsaller = "Top Saller",
    topgatgory = "Top Gatgory",
    brand = "Brand",
    featurecatagory = "Feauter Catagories";

const homeaddress = "Home Dress",
    girlswatches = "Girls Watches",
    mobilephone = "Mobile Phones",
    boyclasses = "Boys Classes",
    tshirt = "Tshirts",
...
const vedio = "vedio",
    review = "Review",
    salepoliy = "Sale Policy",
    returnpolicy = "Return Policy",
    supportpolicy = "Support Policy",
    productlike = "Products may you like";
...
const paypal = "Paypal", stripe = "Stripe", cod = "Cash on Dilevery";
const bud = "\$2300", spent = "\$1200";
const kh = "Pakistan\zindabad\ok";
